...
import Actions, { getLists, openDelete, closeDelete, openNewList, closeNewList, openEditProject, closeEditProject, syncGithub, moveTask } from '@/actions/projects/lists'
          ...
          <DragDropContext onDragEnd={onDragEnd}>
            ...
            <div className={styles.noneList}>
              <Droppable droppableId={`${noneList?.id}`}>
                {(provided) => (
                  <div ref={provided.innerRef}>
                    {noneList && noneList.tasks.map((t, index) => (
