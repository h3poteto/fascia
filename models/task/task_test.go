...
var _ = Describe("Task", func() {
	...
	Describe("Save", func() {
		...
		Context("when list have tasks", func() {
			JustBeforeEach(func() {
				existTask := NewTask(0, newList.Id, newList.UserId, sql.NullInt64{}, "exist task title", "exist task description")
	...
	Describe("ChangeList", func() {
		...
		Context("when destination list have a task", func() {
			...
			JustBeforeEach(func() {
				existTask = NewTask(0, list2.Id, list2.UserId, sql.NullInt64{}, "exist task title", "exist task description")
				existTask.Save(nil, nil)
			})
		...
		Context("when destination list have tasks", func() {
			...
			JustBeforeEach(func() {
				existTask1 = NewTask(0, list2.Id, list2.UserId, sql.NullInt64{}, "exist task title1", "exist task description1")
				existTask1.Save(nil, nil)
				existTask2 = NewTask(0, list2.Id, list2.UserId, sql.NullInt64{}, "exist task title2", "exist task description2")
