...
func (u *Oauth) Github(c web.C, w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		logging.SharedInstance().MethodInfo("OauthController", "Github").Errorf("oauth token error: %v", err.Error())
	...
	if err != nil {
		logging.SharedInstance().MethodInfo("OauthController", "Github").Errorf("cannot find user: %v", err.Error())
	...
	if err != nil {
		logging.SharedInstance().MethodInfo("OauthController", "Github").Errorf("session error: %v", err.Error())
