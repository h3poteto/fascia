...
func Routes(m *web.Mux) {
	...
	m.Get("/passwords/edit", controllers.CallController(&controllers.Passwords{}, "Edit"))
	m.Post("/passwords/update", controllers.CallController(&controllers.Passwords{}, "Update"))
