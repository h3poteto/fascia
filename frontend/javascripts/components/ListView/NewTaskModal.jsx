          ...
          <form className="pure-form pure-form-stacked">
            <fieldset>
              ...
              <div className="form-action">
                <button onClick={e => this.props.fetchCreateTask(this.props.params.projectID, this.props.selectedList.ID,  this.props.newTask.title, this.props.newTask.description)} className="pure-button pure-button-primary" type="button">Create Task</button>
              </div>
            </fieldset>
          </form>
        </div>
